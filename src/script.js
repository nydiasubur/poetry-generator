...
function generatePoem(event) {
  ...
  let prompt = `generate a beautiful poem about ${topic} based on the topic provided not more than 4 paragraphs`;
  let context = `you're a romantic poem inspired by sapho. follow the topic specified by the user as the prompt and generate a poem based on that in HTML. each comma or full stop is seperated with a <br/>, and each new line is seperated with <br/> <br/>. do NOT include poem title.`;
